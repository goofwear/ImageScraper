...
namespace ControlProperty
{
	...
	public class ControlProperty
	{
		...
		public static Dictionary<Type, GetSet> GetTypeList()
		{
            ...
            dic.Add(typeof(Form), new GetSet() { GetValue = (p) => p.ClientSize, SetValue = (p, v) => p.ClientSize = v });
			...
			dic.Add(typeof(NumericUpDown), new GetSet() { GetValue = (p) => p.Value, SetValue = (p, v) => p.Value = (decimal)v });
